      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6">
          ...
          <motion.div 
            ...
            onClick={() => setIndex(0)}
          >
            <img src={studioImages[0].src} alt={studioImages[0].title} className="w-full h-full object-cover" loading="lazy" width="600" height="800" />
          ...
          <motion.div 
            ...
            onClick={() => setIndex(1)}
          >
            <img src={studioImages[1].src} alt={studioImages[1].title} className="w-full h-full object-cover" loading="lazy" width="600" height="400" />
          ...
          <motion.div 
            ...
            onClick={() => setIndex(2)}
          >
            <img src={studioImages[2].src} alt={studioImages[2].title} className="w-full h-full object-cover" loading="lazy" width="600" height="400" />
          ...
          <motion.div 
            ...
            onClick={() => setIndex(3)}
          >
            <img src={studioImages[3].src} alt={studioImages[3].title} className="w-full h-full object-cover" loading="lazy" width="800" height="400" />
