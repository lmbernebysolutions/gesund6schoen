      ...
      <Helmet>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": [{
              "@type": "Question",
              "name": "Was bewirkt LDM Ultraschall?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "LDM® Medical-Spa ist eine Ultraschall-Technologie, die Kollagen aufbaut, Falten reduziert und die Haut strafft. Sie wirkt direkt in den tiefen Hautschichten.",
                "speakable": {
                  "@type": "SpeakableSpecification",
                  "cssSelector": ["#ldm-question-title", "#ldm-answer-text"]
                }
              }
            }]
          })}
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h2 id="ldm-question-title" className="text-4xl lg:text-5xl font-bold mb-6 text-white">
              LDM® Medical-SPA <br />
