...
const Products = () => {
  ...
  return (
    <section id="produkte" className="pb-32 pt-48 md:pt-56 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-16">
        ...
        <div className="flex overflow-x-auto snap-x snap-mandatory gap-8 pb-8 -mx-4 px-4 md:grid md:grid-cols-3 md:gap-12 md:items-start md:overflow-visible md:pb-0 md:px-0 scrollbar-hide">
